...
{% assign completed_files = site.static_files | where_exp: "file", "file.path contains 'Tech Retrospective/'" %}
...
{% assign working_files = site.static_files | where_exp: "file", "file.path contains 'Tech Retrospective/'" %}
...
<div class="related-links">
  ...
  <a href="{{ site.baseurl }}/Tech Retrospective/" class="related-link">
    <span class="link-icon">📰</span>
    <span class="link-text">Tech Retrospective 확인</span>
  </a>
